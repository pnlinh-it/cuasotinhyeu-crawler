...
public class CrunchifyJavaTaskTimeout {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        CompletionService<Boolean> crunchifyService = new ExecutorCompletionService<Boolean>(Executors.newFixedThreadPool(5));

        Collection<CrunchifyRunner> crunchifyThreads = new ArrayList<>(50);
